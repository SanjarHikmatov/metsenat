    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('0', 'Personal'), ('1Legal', 'Legal')], default='0', max_length=10)),
                ('balance', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('university', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
